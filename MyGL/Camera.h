...
constexpr float MOUSE_SENSITIVITY_X = 0.1f;
constexpr float MOUSE_SENSITIVITY_Y = 0.1f;
constexpr float CONTROLLER_SENSITIVITY_X = 1.0f;
constexpr float CONTROLLER_SENSITIVITY_Y = 1.0f;
...
class Camera
{
  public:
    ...
    virtual void on_mouse_movement(float x_offset, float y_offset, bool constrain_pitch = true)
    {
    }
    ...
    virtual void on_rstick(float x, float y, float delta_time, bool constrain_pitch = true)
    {
    }
...
class FpsCamera : public Camera
{
  public:
    ...
    void on_mouse_movement(float x_offset, float y_offset, bool constrain_pitch = true) override;
    void on_mouse_scroll(MouseZoomDirection zoom_direction) override;

    // Gamepad input
    void on_lstick(float x, float y, float delta_time) override;
    void on_rstick(float x, float y, float delta_time, bool constrain_pitch = true) override;
